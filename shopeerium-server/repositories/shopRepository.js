...
const shopRepository = function(){
    ...
    const repository = {
        ...
        selectShops: async() => {                           // Get all Shops
            try {
        ...
        selectShop: async(sellerUsername) => {                  // Get a single shop
            try {
        ...
        insertShop: async(newShop) => {               // Insert new shop 
            try {
                ...
                console.error(error);
                throw new RepositoryError(`Insert Shop of ${newShop.sellerUsername} Failed`);
            }
        }
